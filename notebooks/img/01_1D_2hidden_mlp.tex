...
\begin{tikzpicture}[shorten >=1pt,node distance=3cm,auto]
   ...
   \node[ultra thick, draw, rectangle] (hidden1) [right=2em of input] {$h_0=\sigma(\omega_{0} \cdot x + \beta_{0})$};
   \node[ultra thick, draw, rectangle] (hidden2) [right=2em of hidden1] {$h_1=\sigma(\omega_{1} \cdot h_0 + \beta_{1})$};
